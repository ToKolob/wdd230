...
pasta_entrada = './lesson06/images'

# Pasta de saída (onde as imagens WebP serão salvas)
pasta_saida = './lesson06/images/webp'
...
for arquivo in os.listdir(pasta_entrada):
    if arquivo.endswith('.jpg') or arquivo.endswith('.jpeg'):
        ...
        imagem_jpeg.save(caminho_arquivo_saida, 'WEBP', quality=50)  # Aqui, 80 é um valor de qualidade arbitrário, você pode ajustar conforme necessário
